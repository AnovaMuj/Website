...
const Footer = () => {
  return (
    <>
      <div className="MobileFooterSpacer"></div>
      <div className="FooterTopLeftFiller">
        <h2 className="FooterFillerWhite">X</h2>
        <h2 className="FooterFillerRed">X</h2>
        <h2 className="FooterFillerWhite">X</h2>
      </div>
      ...
      <h3 className="FooterCopyright">
        {" "}
        &#169;All <span className="FooterFillerRed">Copyrights</span> Reserved 2023
      </h3>
      <div className="contain" id="ContactUsSection">
        <div className="ContactFrame">
          <div className="contactmain">
            <div className="contactcard">
              <a href="https://instagram.com/anova.muj?igshid=MzRlODBiNWFlZA==" target="_blank">
            ...
            <div className="contactcard">
              <svg height="30px" width="30px" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" className="dribble">
                ...
                <path d="M28.352 36.914c0 0-3.032-21.087-15.63-34.292M1.269 17.848c0 0 24.2 2.117 32.075-11.102M7.804 34.152c0 0 8.624-19.807 31.058-12.194" strokeMiterlimit="10" stroke="#ea4c89" fill="none"></path>
              </svg>
            </div>
            <div className="contactcard">
              <svg height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 473.931 473.931" xmlSpace="preserve" className="linkedin">
                <circle style={{ fill: "#4A86C5", cx: "236.966", cy: "236.966", r: "236.966" }} className="linkedin" />
                <path
                  style={{ fill: "#3D80B2" }}
                  className="linkedin"
	...
	C464.307,303.823,463.496,306.562,462.646,309.275z"
                />
                <g>
                  <polygon style={{ fill: "#377CA5", points: "465.097,301.017 465.097,301.017 465.082,301.07 	" }} className="linkedin" />
                  <path
                    style={{ fill: "#377CA5" }}
                    className="linkedin"
	 ...
	 M123.886,318.341h50.944V165.083h-50.944V318.341z"
            ...
            <div className="contactcard">
              <svg height="30px" width="30px" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg" className="telegram">
                ...
                <path d="M33.95,15l-3.746,19.126c0,0-0.161,0.874-1.245,0.874c-0.576,0-0.873-0.274-0.873-0.274l-8.114-6.733 l-3.97-2.001l-5.095-1.355c0,0-0.907-0.262-0.907-1.012c0-0.625,0.933-0.923,0.933-0.923l21.316-8.468 c-0.001-0.001,0.651-0.235,1.126-0.234C33.667,14,34,14.125,34,14.5C34,14.75,33.95,15,33.95,15z" fill="#fff"></path>
                <path d="M23,30.505l-3.426,3.374c0,0-0.149,0.115-0.348,0.12c-0.069,0.002-0.143-0.009-0.219-0.043 l0.964-5.965L23,30.505z" fill="#b0bec5"></path>
                <path d="M29.897,18.196c-0.169-0.22-0.481-0.26-0.701-0.093L16,26c0,0,2.106,5.892,2.427,6.912 c0.322,1.021,0.58,1.045,0.58,1.045l0.964-5.965l9.832-9.096C30.023,18.729,30.064,18.416,29.897,18.196z" fill="#cfd8dc"></path>
              </svg>
            </div>
            <div className="contactcard">
